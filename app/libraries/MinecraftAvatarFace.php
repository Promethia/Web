...
class MinecraftAvatarFace {

    function __construct($inputUser, $inputSize = 48, $inputView = 'f') {

        $size = isset($inputSize) ? max(8, min(250, $inputSize)) : 48;
        $user = isset($inputUser) ? $inputUser : '';
        $view = isset($inputView) ? substr($inputView, 0, 1) : 'f';
